...
describe('server.js', () => {
  ...
  describe('POST', () => {
    it('should throw a fit if handed a malformed schema', async() => {
      ...
      const response = await server.request(badSchema);
    ...
    it('should return a good response if handed a correct schema', async() => {
      ...
      const response = await server.request(goodSchema);
    ...
    it('should allow releaseYear to be optional', async() => {
      ...
      const response = await request(server).post('/games/').(optionalSchema);
